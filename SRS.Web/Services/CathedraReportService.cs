...
namespace UserManagement.Services
{
    public class CathedraReportService
    {
        ...
        private string GenerateBodyForTemplate(CathedraReport report)
        {
            ...
            {
                [REPORT_HEADER] = GetHeaderOfReport(report), //Done
                [PUNKT_1] = punktOne, //Done
                [PUNKT_2] = punktTwo, //Done
                [PUNKT_2_DESCRIPTION] = punktTwoDescr, //Done
                [PUNKT_2_CV] = punktTwoCV, //Done
                [PUNKT_2_DEFENSES] = punktTwoDefenses, //Done
                [PUNKT_2_PUBLICATIONS] = punktTwoPublications, //Done
                [PUNKT_2_PATENTS] = punktTwoPatents, //Done
                [PUNKT_2_OTHER] = punktTwoOther, //Done
                [PUNKT_3] = punktTree, //Done
                [PUNKT_3_DESCRIPTION] = punktTreeDescr, //Done
                [PUNKT_3_CV] = punktTreeCV, //Done
                [PUNKT_3_DEFENSES] = punktTreeDefenses, //Done
                [PUNKT_3_PUBLICATIONS] = punktTreePublications, //Done
                [PUNKT_3_PATENTS] = punktTreePatents, //Done
                [PUNKT_3_OTHER] = punktTreeOther, //Done
                [PUNKT_4] = punktFour, //Done
                [PUNKT_4_DESCRIPTION] = punktFourDescr, //Done
                [PUNKT_4_CV] = punktFourCV, //Done
                [PUNKT_4_DEFENSES] = punktFourDefenses, //Done
                [PUNKT_4_PUBLICATIONS] = punktFourPublications, //Done
                [PUNKT_4_PATENTS] = punktFourPatents, //Done
                [PUNKT_4_OTHER] = punktFourOther, //Done
                [PUNKT_5] = punktFive, //Done
                [PUNKT_6] = punktSix, //Done
                [PUNKT_6_1] = punktSixOne, //Done
                [PUNKT_6_2] = punktSixTwo, //Done
                [PUNKT_8] = punktEight, //Done
                [PUNKT_9] = punktNine, //Done
                [PUNKT_9_MONOGRAPHY] = punktNineMonography, //Done
                [PUNKT_9_MONOGRAPHY_TABLE] = punktNineMonographyTable, //Done
                [PUNKT_9_BOOK] = punktNineBook, //Done
                [PUNKT_9_BOOK_TABLE] = punktNineBookTable, //Done
                [PUNKT_9_TRAINING_BOOK] = punktNineTrainingBook, //Done
                [PUNKT_9_TRAINING_BOOK_TABLE] = punktNineTrainingBookTable, //Done
                [PUNKT_9_OTHER] = punktNineOther, //Done
                [PUNKT_9_OTHER_TABLE] = punktNineOtherTable, //Done
                [PUNKT_9_ARTICLES_HEADER] = punktNineArticlesHeader, //Done
                [PUNKT_9_ARTICLES_INTERNATIONAL_METRICALS] = punktNineArticlesInternationalScienceDb, //Done
                [PUNKT_9_ARTICLES_IMPACT_FACTOR] = punktNineArticlesImpact, //Done
                [PUNKT_9_ARTICLES_INTERNATIONAL] = punktNineArticlesInternational, //Done
                [PUNKT_9_ARTICLES_INTERNATIONAL_OTHER] = punktNineArticlesInternationalOther, //Done
                [PUNKT_9_ARTICLES_NATIONAL_FAH] = punktNineArticlesNationalFah, //Done
                [PUNKT_9_ARTICLES_NATIONAL] = punktNineArticlesNational, //Done
                [PUNKT_9_CONFERENCES_HEADER] = punktNineConferencesHeader, //Done
                [PUNKT_9_CONFERENCES_INTERNATIONAL] = punktNineConferencesInternational, //Done
                [PUNKT_9_CONFERENCES_NATIONAL] = punktNineConferencesNational, //Done
                [PUNKT_10] = punktTen, //Done
                [PUNKT_11] = punktEleven, //Done
                [PUNKT_11_1] = punktElevenOne, //Done
                [PUNKT_11_2] = punktElevenTwo, //Done
                [PUNKT_12] = punktTwelve, //Done
                [PUNKT_13] = punktThirteen, //Done
                [FOOTER] = footer, //Done
            });
            return formetedBody;
        }
