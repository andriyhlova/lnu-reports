...
{
    public class FacultyReportSpecification : BaseFilterSpecification<FacultyReport>
    {
        public FacultyReportSpecification(DepartmentReportFilterModel filterModel, Expression<Func<FacultyReport, bool>> expression)
            : base(
                  filterModel.Skip,
                  filterModel.Take,
                  expression.AndAlso(
