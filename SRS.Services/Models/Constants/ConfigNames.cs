namespace SRS.Services.Models
{
    ...
    {
        public const string PandocPath = nameof(PandocPath);
        public const string HtmlFilePath = nameof(HtmlFilePath);
        ...
        public const string FromEmailAddress = nameof(FromEmailAddress);
    }
}
